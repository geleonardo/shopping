...
import com.gudushidai.mall.dao.ClassificationDao;
import com.gudushidai.mall.dao.ProductDao;
import com.gudushidai.mall.dao.ProductMapper;
...
public class ProductServiceImpl implements ProductService {
    ...
    public List<Product> findHotProduct() {
        return productMapper.findByIsHot();
    }
...
//        calendar.add(Calendar.DAY_OF_MONTH, -14);
    ...
    @Override
    public List<Product> findAllProduct(int pageNo, int pageSize) {
        int start = pageNo*pageSize;
        int rows = pageSize;
        return productMapper.findAllProduct(start,rows);
    }

    @Override
    public List<Product> searchAllProduct(int pageNo, int pageSize, String good_name) {
        int start = pageNo*pageSize;
        int rows = pageSize;
        return productMapper.searchAllProduct(start,rows,good_name);
    }
}
