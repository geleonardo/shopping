...
<div id="main" style="display: none;">
    <form name=alipayment id="alipayment" action='/mall/pay/gotoPay' method=post target="_blank">
        <div id="body" style="clear:left">
            <dl class="content">
                ...
                <dt>订单名称：</dt>
                <dd>
                    <input id="WIDsubject" name="WIDsubject" value="杂货铺订单" />
                </dd>
                <hr class="one_line">
                <dt>付款金额：</dt>
                <dd>
                    <input id="WIDtotal_amount" name="WIDtotal_amount" value="${total}" />
                </dd>
                <hr class="one_line"/>
                <dt>商品描述：</dt>
                <dd>
